...
final class DebitNotes extends Resource
{
    /**
     * @param  array<string, mixed>  $filters
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'debitNotes/getAll')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'debitNotes/getOne')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'debitNotes/insert')]
    public function insert(int $companyId, DocumentDto|array $data): array
    {
        ...
        event(new DocumentCreated($result, 'debitNotes'));
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'debitNotes/update')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'debitNotes/delete')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'debitNotes/count')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'debitNotes/getPDFLink')]
