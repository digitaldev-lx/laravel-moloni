...
final class InvoiceReceipts extends Resource
{
    /**
     * @param  array<string, mixed>  $filters
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'invoiceReceipts/getAll')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'invoiceReceipts/getOne')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'invoiceReceipts/insert')]
    public function insert(int $companyId, DocumentDto|array $data): array
    {
        ...
        event(new DocumentCreated($result, 'invoiceReceipts'));
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'invoiceReceipts/update')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'invoiceReceipts/delete')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'invoiceReceipts/count')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'invoiceReceipts/getPDFLink')]
