...
final class Waybills extends Resource
{
    /**
     * @param  array<string, mixed>  $filters
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'waybills/getAll')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'waybills/getOne')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'waybills/insert')]
    public function insert(int $companyId, DocumentDto|array $data): array
    {
        ...
        event(new DocumentCreated($result, 'waybills'));
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'waybills/update')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'waybills/delete')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'waybills/count')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'waybills/getPDFLink')]
