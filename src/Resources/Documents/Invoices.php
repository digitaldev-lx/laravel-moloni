...
final class Invoices extends Resource
{
     ...
     */
    #[MoloniEndpoint(path: 'invoices/getAll')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'invoices/getOne')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'invoices/insert')]
    public function insert(int $companyId, DocumentDto|array $data): array
    {
        ...
        event(new DocumentCreated($result, 'invoices'));
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'invoices/update')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'invoices/delete')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'invoices/count')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'invoices/getPDFLink')]
