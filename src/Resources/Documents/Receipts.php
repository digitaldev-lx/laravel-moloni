...
final class Receipts extends Resource
{
     ...
     */
    #[MoloniEndpoint(path: 'receipts/getAll')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'receipts/getOne')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'receipts/insert')]
    public function insert(int $companyId, DocumentDto|array $data): array
    {
        ...
        event(new DocumentCreated($result, 'receipts'));
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'receipts/update')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'receipts/delete')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'receipts/count')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'receipts/getPDFLink')]
