...
final class DeliveryNotes extends Resource
{
    /**
     * @param  array<string, mixed>  $filters
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'deliveryNotes/getAll')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'deliveryNotes/getOne')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'deliveryNotes/insert')]
    public function insert(int $companyId, DocumentDto|array $data): array
    {
        ...
        event(new DocumentCreated($result, 'deliveryNotes'));
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'deliveryNotes/update')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'deliveryNotes/delete')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'deliveryNotes/count')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'deliveryNotes/getPDFLink')]
