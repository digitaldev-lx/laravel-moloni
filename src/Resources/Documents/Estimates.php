...
final class Estimates extends Resource
{
    /**
     * @param  array<string, mixed>  $filters
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'estimates/getAll')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'estimates/getOne')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'estimates/insert')]
    public function insert(int $companyId, DocumentDto|array $data): array
    {
        ...
        event(new DocumentCreated($result, 'estimates'));
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'estimates/update')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'estimates/delete')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'estimates/count')]
     ...
     * @return array<string, mixed>
     */
    #[MoloniEndpoint(path: 'estimates/getPDFLink')]
